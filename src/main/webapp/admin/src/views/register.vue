  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(247, 240, 240, 0.7);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">家教平台系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiaoshi'">
			...
			<el-form-item label="专业" class="input" v-if="tableName=='jiaoshi'">
			...
			<el-form-item label="学历" class="input" v-if="tableName=='jiaoshi'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210321/777e0d8a59434ddb82891fee3882330a.jpg");
		height: 100vh;
