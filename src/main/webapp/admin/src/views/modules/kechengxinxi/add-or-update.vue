              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengrenwu" label="课程任务" prop="kechengrenwu">
                    <span>{{ruleForm.kechengrenwu}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课程特点" prop="kechengtedian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="课程特点"
                  v-model="ruleForm.kechengtedian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechengtedian" label="课程特点" prop="kechengtedian">
                    <span>{{ruleForm.kechengtedian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengrenwu = true;
            continue;
	            	            ...
	            	            if(o=='kechengtedian'){
            this.ruleForm.kechengtedian = obj[o];
	    this.ro.kechengtedian = true;
            continue;
          }
	            	            if(o=='jiaoshigonghao'){
