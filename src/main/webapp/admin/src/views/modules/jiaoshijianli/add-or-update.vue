          ...
          <el-form-item class="input" label="毕业学校" prop="biyexuexiao">
              <el-input v-model="ruleForm.biyexuexiao" 
                placeholder="毕业学校" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="工作经历" prop="gongzuojingli">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuojingli" label="工作经历" prop="gongzuojingli">
                    <span>{{ruleForm.gongzuojingli}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="个人特长" prop="gerentezhang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="个人特长"
                  v-model="ruleForm.gerentezhang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerentezhang" label="个人特长" prop="gerentezhang">
                    <span>{{ruleForm.gerentezhang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongzuojingli = true;
            continue;
	            	            ...
	            	            if(o=='gerentezhang'){
            this.ruleForm.gerentezhang = obj[o];
	    this.ro.gerentezhang = true;
            continue;
          }
	            	            if(o=='qiwangxinzi'){
	...
	this.ruleForm.xiangxineirong = this.ruleForm.xiangxineirong.replace(reg,'../../../ssmrsvl9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiaoshijianli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaoshijianliCrossAddOrUpdateFlag = false;
                  this.parent.search();
