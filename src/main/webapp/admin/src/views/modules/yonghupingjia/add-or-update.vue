  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务评价" prop="fuwupingjia">
        ...
        <div v-else>
          <el-form-item class="input" label="服务评价" prop="fuwupingjia">
	      <el-input v-model="ruleForm.fuwupingjia"
                placeholder="服务评价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务打分" prop="fuwudafen">
          <el-select v-model="ruleForm.fuwudafen" placeholder="请选择服务打分">
            <el-option
                v-for="(item,index) in fuwudafenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="服务打分" prop="fuwudafen">
	      <el-input v-model="ruleForm.fuwudafen"
                placeholder="服务打分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwupingjia = true;
            continue;
	            	            ...
	            	            if(o=='fuwudafen'){
            this.ruleForm.fuwudafen = obj[o];
	    this.ro.fuwudafen = true;
            continue;
          }
	            	            if(o=='pingjiashijian'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                          ...
                                                          this.fuwupingjiaOptions = "1星,2星,3星,4星,5星".split(',')
                                        this.fuwudafenOptions = "6,7,8,9,10".split(',')
                                                                                  },
                    // 下二随
