          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="条件" prop="tiaojian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="条件"
                  v-model="ruleForm.tiaojian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tiaojian" label="条件" prop="tiaojian">
                    <span>{{ruleForm.tiaojian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
            continue;
	            	            ...
	            	            if(o=='tiaojian'){
            this.ruleForm.tiaojian = obj[o];
	    this.ro.tiaojian = true;
            continue;
          }
	            	            if(o=='shangbandidian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhaopinjiaoshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhaopinjiaoshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
